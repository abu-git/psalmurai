...
function AfterLandingItem({link, image, spotify, itunes, tidal, youtube, bandcamp, audiomack, title}) {
    return (
        <div className='flex flex-col justify-center items-center py-5'>
            <Link href={link} passHref>
                <img src={`/${image}`} width={200} height={200} alt="Psalmurai & Xblaze | Unknown Error" className='brightness-90 hover:brightness-100 cursor-pointer' />
            </Link>
            ...
            <div className='flex justify-center items-center pt-8'>
                ...
                {itunes && (<a href={itunes} target='_blank' rel='noreferrer'>
                ...
                {tidal && (<a href={tidal} target='_blank' rel='noreferrer'>
                ...
                {bandcamp && (<a href={bandcamp} target='_blank' rel='noreferrer'>
                ...
                {audiomack && (<a href={audiomack} target='_blank' rel='noreferrer'>
            ...
            <Link href={link} passHref>
                <h4 className='italic text-lg text-black font-bold mt-3 cursor-pointer'>{title}</h4>
            </Link>
...
export default AfterLandingItem